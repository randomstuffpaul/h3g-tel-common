...
class ImsPhoneCommandInterface extends BaseCommands implements CommandsInterface {
    ...
    public void supplyIccPerso(String passwd, Message result) {
    }
    ...
    public void sendSMSmore(String smscPDU, String pdu, Message response) {
    }

    public void sendCdmaSmsMore(byte[] pdu, Message response) {
    }
