...
public class IccCardApplicationStatus {
    ...
    public int perso_unblock_retries;
    ...
    public String toString() {
        ...
        if (this.app_type == AppType.APPTYPE_CSIM || this.app_type == AppType.APPTYPE_USIM || this.app_type == AppType.APPTYPE_ISIM) {
            ...
            sb.append("-").append(this.pin1_num_retries).append("/").append(this.pin2_num_retries);
            sb.append("/").append(this.puk1_num_retries).append("/").append(this.puk2_num_retries);
        }
        sb.append("}");
        return sb.toString();
    }
