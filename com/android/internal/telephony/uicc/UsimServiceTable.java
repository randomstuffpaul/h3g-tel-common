...
public final class UsimServiceTable extends IccServiceTable {
    ...
    public boolean isSSTAvailable(SimService service) {
        return super.isSSTAvailable(service.ordinal());
    }

    public boolean isSSTActive(SimService service) {
        return super.isSSTActive(service.ordinal());
    }
}
