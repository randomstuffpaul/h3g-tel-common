...
public class EventLogTags {
    ...
    public static final int NITZ_INFORMATION = 1050101;
    ...
    public static void writeNitzInformation(String nitzString) {
        EventLog.writeEvent(NITZ_INFORMATION, nitzString);
    }
}
