...
public class OperatorInfo implements Parcelable {
    public static final Creator<OperatorInfo> CREATOR = new C00181();
    int lac;
    ...
    static class C00181 implements Creator<OperatorInfo> {
        C00181() {
        }
    ...
    public OperatorInfo(String operatorAlphaLong, String operatorAlphaShort, String operatorNumeric, State state, int lac) {
        ...
        this.mOperatorNumeric = operatorNumeric;
        this.mState = state;
        if (CscFeature.getInstance().getEnableStatus("CscFeature_RIL_UseRatInfoDuringPlmnSelection")) {
