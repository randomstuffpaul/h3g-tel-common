...
class IconLoader extends Handler {
    ...
    private void readId() {
        ...
        this.mSimFH.loadEFImgLinearFixedSTK(this.mRecordNumber, obtainMessage(1));
    }
    ...
    private void readIconData() {
        ...
        this.mSimFH.loadEFImgTransparentSTK(this.mId.mImageId, 0, 0, this.mId.mLength, msg);
    }
    ...
    public static Bitmap parseToBnW(byte[] data, int length) {
        ...
        if (pixelIndex != numOfPixels) {
            CatLog.m2d("IconLoader", "parseToBnW; size error");
        }
    ...
    public static Bitmap parseToRGB(byte[] data, int length, boolean transparency, byte[] clut) {
        ...
        valueIndex2 = valueIndex + 1;
        int numOfClutEntries = data[valueIndex] & 255;
        ...
        while (i < numOfPixels) {
            ...
            int pixelIndex = i + 1;
            pixels[i] = Color.rgb(clut[clutIndex], clut[clutIndex + 1], clut[clutIndex + 2]);
            bitIndex -= bitsPerImg;
            i = pixelIndex;
            valueIndex = valueIndex2;
        }
