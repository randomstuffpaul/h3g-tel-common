...
class PlayToneParams extends CommandParams {
    ...
    PlayToneParams(CommandDetails cmdDet, TextMessage textMsg, Tone tone, Duration duration, boolean vibrate, boolean hasIcon) {
        this(cmdDet, textMsg, tone, duration, vibrate);
