...
public final class InboundSmsTracker {
    ...
    public InboundSmsTracker(byte[] pdu, long timestamp, int destPort, boolean is3gpp2, String address, boolean is3gpp2WapPdu) {
        this.mPdu = pdu;
        this.mTimestamp = timestamp;
        this.mDestPort = destPort;
        this.mIs3gpp2 = is3gpp2;
    ...
    ContentValues getContentValues() {
        ...
        if (this.mAddress != null) {
            ...
            if (CSCFEATURE_RIL_LMS_REASSEMBLE_TIMEOUTS_CTC) {
                values.put(CellBroadcasts.MESSAGE_FORMAT, getFormat());
            }
        }
        return values;
    }
