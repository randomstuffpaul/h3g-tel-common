...
public class SuppServiceNotification {
    ...
    public int code;
    public int index;
    public int mtConference;
    public int notificationType;
    public String number;
    public int type;

    public String toString() {
        return super.toString() + " mobile" + (this.notificationType == 0 ? " originated " : " terminated ") + " code: " + this.code + " index: " + this.index + " mtConference: " + this.mtConference + " \"" + PhoneNumberUtils.stringFromStringAndTOA(this.number, this.type) + "\" ";
    }
}
