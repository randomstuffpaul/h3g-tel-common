...
public class SmsHeader {
    ...
    public static boolean udhi_isMwi = false;
    public static boolean udhi_mwiDontStore = true;
    public static int udhi_voicemailcount = 0;
        ...
        while (inStream.available() > 0) {
            ...
            switch (id) {
                ...
                case 68:
                    ...
                    break;
                case 192:
                    Rlog.i("SmsHeader", "id: " + id + "value: " + inStream.read());
                    break;
                default:
