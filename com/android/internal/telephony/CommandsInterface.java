...
public interface CommandsInterface {
    ...
    public static final String CB_FACILITY_BA_PS = "PH-SIM";
    ...
    public static final int GSM_SMS_FAIL_CAUSE_DSAC_FAIL = 214;
    ...
    void acceptCall(int i, Message message);

    void acceptCall(Message message);

    void accessPhoneBookEntry(int i, int i2, int i3, AdnRecord adnRecord, String str, Message message);
    ...
    void changeIccSimPerso(String str, String str2, Message message);
    ...
    void dial(String str, int i, UUSInfo uUSInfo, CallDetails callDetails, Message message);

    void dialEmergencyCall(String str, int i, Message message);

    void dialEmergencyCall(String str, int i, CallDetails callDetails, Message message);
    ...
    void getCbConfig(Message message);
    ...
    void getPhoneBookEntry(int i, int i2, int i3, String str, Message message);

    void getPhoneBookStorageInfo(int i, Message message);
    ...
    void getSIMLockInfo(int i, int i2, Message message);

    void getSignalStrength(Message message);

    void getSmscAddress(Message message);

    void getUsimPBCapa(Message message);
    ...
    void hangupVT(int i, Message message);

    void hangupWaitingOrBackground(Message message);

    void holdCall(Message message);
    ...
    void modifyCallConfirm(CallModify callModify, Message message);

    void modifyCallInitiate(CallModify callModify, Message message);
    ...
    void registerForCsFallback(Handler handler, int i, Object obj);
    ...
    void registerForHomeNetwork(Handler handler, int i, Object obj);
    ...
    void registerForImsRegistrationStateChanged(Handler handler, int i, Object obj);

    void registerForImsRetryOver(Handler handler, int i, Object obj);
    ...
    void registerForModifyCall(Handler handler, int i, Object obj);
    ...
    void registerForSap(Handler handler, int i, Object obj);
    ...
    void registerForVoiceSystemIdNotified(Handler handler, int i, Object obj);
    ...
    void sendCdmaSmsMore(byte[] bArr, Message message);

    void sendDtmf(char c, Message message);

    void sendEncodedUSSD(byte[] bArr, int i, int i2, Message message);
    ...
    void sendSMSmore(String str, String str2, Message message);
    ...
    void setOnCatCallControlResult(Handler handler, int i, Object obj);
    ...
    void setOnCatSendSmsResult(Handler handler, int i, Object obj);
    ...
    void setOnPbInitComplete(Handler handler, int i, Object obj);

    void setOnReleaseCompleteMessageRegistrant(Handler handler, int i, Object obj);

    void setOnRestrictedStateChanged(Handler handler, int i, Object obj);

    void setOnSS(Handler handler, int i, Object obj);

    void setOnSendDTMFResult(Handler handler, int i, Object obj);

    void setOnSignalStrengthUpdate(Handler handler, int i, Object obj);

    void setOnSimPbReady(Handler handler, int i, Object obj);

    void setOnSmsDeviceReady(Handler handler, int i, Object obj);

    void setOnSmsOnSim(Handler handler, int i, Object obj);

    void setOnSmsStatus(Handler handler, int i, Object obj);

    void setOnStkCallStatusResult(Handler handler, int i, Object obj);
    ...
    void setSimInitEvent(Message message);
    ...
    void setVoiceDomainPref(int i, Message message);
    ...
    void supplyIccPerso(String str, Message message);
    ...
    void supplyNetworkDepersonalization(String str, int i, Message message);
    ...
    void unSetOnCatCallControlResult(Handler handler);
    ...
    void unSetOnCatSendSmsResult(Handler handler);
    ...
    void unSetOnPbInitComplete(Handler handler);

    void unSetOnReleaseCompleteMessageRegistrant(Handler handler);

    void unSetOnRestrictedStateChanged(Handler handler);

    void unSetOnSS(Handler handler);

    void unSetOnSendDTMFResult(Handler handler);

    void unSetOnSignalStrengthUpdate(Handler handler);

    void unSetOnSimPbReady(Handler handler);

    void unSetOnSmsDeviceReady(Handler handler);

    void unSetOnSmsOnSim(Handler handler);

    void unSetOnSmsStatus(Handler handler);

    void unSetOnStkCallStatusResult(Handler handler, int i, Object obj);
    ...
    void unregisterForCsFallback(Handler handler);
    ...
    void unregisterForHomeNetwork(Handler handler);

    void unregisterForIccRefresh(Handler handler);

    void unregisterForIccStatusChanged(Handler handler);

    void unregisterForImsImsRetryOver(Handler handler);

    void unregisterForImsNetworkStateChanged(Handler handler);

    void unregisterForImsRegistrationStateChanged(Handler handler);
    ...
    void unregisterForModifyCall(Handler handler);
    ...
    void unregisterForSap(Handler handler);
    ...
    void unregisterForVoiceSystemIdNotified(Handler handler);
